...
/** @description 重新導向訊息 */
export class RedirectionMessage {
    /** 
...
export class HttpStatusCode {
    /** @description 資訊回應 */
    static readonly INFORMATIONAL_RESPONSE: typeof InformationResponse = InformationResponse
    /** @description 成功回應 */
    static readonly SUCCESSFUL_RESPONSE: typeof SuccessfulResponse = SuccessfulResponse
    /** @description 重新導向訊息 */
    static readonly REDIRECTION_MESSAGE: typeof RedirectionMessage = RedirectionMessage
    /** @description 用戶端錯誤回應 */
    static readonly CLIENT_ERROR_RESPONSE: typeof ClientErrorResponse = ClientErrorResponse
    /** @description 伺服器錯誤回應 */
    static readonly SERVER_ERROR_RESPONSE: typeof ServerErrorResponse = ServerErrorResponse

    static readonly category_map: Map<number, HttpStatusType> = new Map<number, HttpStatusType>([
    ...
    static readonly status_code_object_map: Map<number, HttpStatus> = new Map<number, HttpStatus>([
    ...
    static fromCode(code: number): HttpStatus {
        const http_status: HttpStatus | undefined = this.status_code_object_map.get(code)
...
export class HttpError extends Error {
    private _status_code: ClientErrorResponse | ServerErrorResponse

    static readonly http_error_name_map: Map<number, string> = new Map<number, string>([
        [400, 'Bad Request'],
        [401, 'Unauthorized'],
    ...
    static getErrorName(status_code: ClientErrorResponse | ServerErrorResponse): string | undefined {
        return HttpError.http_error_name_map.get(status_code as number)
    }

    constructor(code: number, message: string = '') {
        super(message)
        const category: HttpStatusType | undefined = HttpStatusCode.getCategory(code)
        if (category === ClientErrorResponse || category === ServerErrorResponse) {
            this._status_code = HttpStatusCode.fromCode(code)
            const http_error_name: string | undefined = HttpError.http_error_name_map.get(code)
    ...
    public get status_code(): number {
        return this._status_code as number
    }
}